...
import com.devedu.Login.SignInActivity;
import com.devedu.Model.UserModel;
import com.devedu.R;
import com.devedu.databinding.FragmentProfileBinding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding.cardRate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                startActivity(new Intent(Intent.ACTION_VIEW,Uri.parse("https://play.google/store/apps/details?id="+getContext().getPackageName())));
            }
        });
    ...
    public void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if(requestCode==1){
            ...
            if(data !=null){
                ...
                updateProflie(data.getData());
            }
        }
    }

    private void updateProflie(Uri uri) {

        loadingDialog.show();

        final StorageReference reference = storage.getReference().child("proflie_image")
